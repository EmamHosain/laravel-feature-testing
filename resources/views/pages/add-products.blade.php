...
<div class="container px-5 py-24 mx-auto">
    ...
    <form action="{{ route('create.product') }}" method="POST"
        ...
        @csrf
        <h2 class="text-gray-900 text-lg mb-1 font-medium title-font text-center">Add products</h2>
        ...
        <button type="submit"
            class="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Add</button>
